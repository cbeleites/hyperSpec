...
#' A great discussion of color issues can be found in the \pkg{colorspace} package.  The
#' \pkg{Polychrome} package has further discussion and utilities for choosing qualitative
