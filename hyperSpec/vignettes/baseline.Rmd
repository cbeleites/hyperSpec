...
## The Mechanism of Automatically Fitting the Baseline in `spc.fit.poly.below()` {#sec:autofit-baseline}
...
The baselines and respective supporting points for each iteration of `spc.fit.poly.below(chondro_mini[1], poly.order = 1)`{.r} are shown in figure \@ref(fig:iter).
...
Figures \@ref(fig:figorder0), \@ref(fig:figorder1), \@ref(fig:figorder2) show the resulting baseline polynomial of `spc.fit.poly.below (chondro_mini [1], poly.order = order)`{.r} with `order`{.r} $=$ 0 to 3 for the first spectrum of the chondro_mini data set.
...
The resulting baselines for `spc.fit.poly.below (chondro_mini [1], poly.order = 1, noise = 12)`{.r} of the whole spectrum are shown in the middle and lower part of figure \@ref(fig:fig4).
