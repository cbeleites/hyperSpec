...
Please note that a specialized package for baseline fitting, package **baseline**[`r cite_pkg(pkg_bib, "baseline")`], exists that provides many more methods to fit baselines to spectroscopic data.
