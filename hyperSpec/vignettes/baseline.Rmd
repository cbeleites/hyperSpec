...
pkg_bib <- knitr::write_bib(c("hyperSpec", "baseline"),
...
Please note that a specialized package for baseline fitting, package **baseline**[`r cite_pkg("baseline", bib = pkg_bib)`], exists that provides many more methods to fit baselines to spectroscopic data.
