...
```{r chondro-import}
# Download file from:
raw_data_url <- 'https://media.githubusercontent.com/media/cbeleites/hyperSpec/master/Vignettes/fileio/txt.Renishaw/chondro.txt'
dir.create('rawdata', F)
download.file(raw_data_url, 'rawdata/chondro.txt')
