...
2. I general, it seems that this tutorial could be split into several smaller tutorials. I think, there should be one additional short tutorial "Quick-start".
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-2`

1. `# FIXME`{.r} Is Appendix supported in single Rmd files? I'm not sure. 
```
<!-- ======================================================================= -->
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-3`

1. `# FIXME`{.r} Appendix is mentioned (above). Possible issue. 
```
<!-- ======================================================================= -->
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-4`

1. `# FIXME`{.r} "Four slots contain the parts..." only 3 slots are mentioned in the list!
And, as far as I know, the `@log`{.r} slot will be removed in the new version.
```
<!-- ======================================================================= -->
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-5`

1. "appendix" is mentioned. Possible issue.
```
<!-- ======================================================================= -->
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-8`

1. `# FIXME: `{.r}
the sentence `"must have the same rows and columns, respectively."` seems to be 
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-11`

1. `# FIXME: `{.r} Is the chunk below still needed?
```
<!-- ======================================================================= -->
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `hyperspec-12`


1. `# FIXME`{.r} The following functions are deprecated:
     
     `logbook`{.r}                        | logging the data treatment
     `logentry`{.r}                       | make a logbook entry

2. `# TODO`{.r}  A better version of the table could be created if `pkgdown` website 
