...
Besides, package **tripack**[`r cite_pkg(pkg_bib, "tripack")`] is mentioned, but not used in this vignette.
...
**`levelplot()`{.r}**
:  package **hyperSpec** has a method for package **lattice**[`r cite_pkg(pkg_bib, "lattice")`] function `levelplot()`{.r}.
...
If available, the package package **plotrix**`[r cite_pkg(pkg_bib, "plotrix")`] is used to produce the cut mark.
...
Voronoi uses `panel.voronoi()`{.r} from package **latticeExtra**[`r cite_pkg(pkg_bib, "latticeExtra")`].
The tesselation is calculated by default using package **deldir**[`r cite_pkg(pkg_bib, "deldir")`], but package **tripack**[`r cite_pkg(pkg_bib, "tripack")`] can also be used.
...
Package **rgl**[`r cite_pkg(pkg_bib, "rgl")`] offers fast 3d plotting in R.
...
Class `hyperSpec`{.r} objects do not yet directly support plotting with package **ggplot2**[`r cite_pkg(pkg_bib, "ggplot2")`].
