---
# For bookdown ---------------------------------------------------------------
bookdown_file_name: laser
bookdown_titles: |
  # `laser`: Unstable Laser Emission {#laser}
# For vignette ---------------------------------------------------------------
title:       Unstable Laser Emission
subtitle:    "Example Workflow for Unstable Laser Emission Dataset `laser`"
description: "laser: Example workflow for unstable laser emission dataset `laser`."
# Authors --------------------------------------------------------------------
author:
