...
Table \@ref(tab:getters) shows the main functions that can be used with class `hyperSpec`{.r} to access the object ("getters").
...
## Summary of Replacement Functions for **_hyperSpec_** Objects (setters) {#sec:setters}
  ...
  Table \@ref(tab:setters) shows the main functions that can be used with class `hyperSpec`{.r} to modify the object ("setters").
