...
* `j` refers to columns of the `@data`{.r} slot. `j` can be integer indices, a logical vector or the name of a column.  However, there is no guaranteed order to `colnames(x)`{.r} so using integer indices is dangerous.
