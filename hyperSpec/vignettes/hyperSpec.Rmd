...
One can see that there are several ways to get the spectral data: `x$spc`{.r}, `x[[]]`{.r}, `x$..`{.r}.  The first two forms return a matrix, while the last returns a `data.frame`.
