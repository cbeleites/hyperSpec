...
More information about converting existing data into `hyperSpec` objects can be found in the [fileio](#abt-vigs) vignette.
...
points(wl(chondro)[i[, 2]], chondro[[!OK]], pch = 19, col = CB7[4], cex = 0.5)
```
...
plot(chondro.merged[1:100], "mat", col = matcols)
```
