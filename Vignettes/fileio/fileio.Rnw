...
<<test-read.jdx, echo = FALSE, results=hide>>=
tests <- test_file_keep ("test-read.jdx.R", reporter, tests)
@
...
<<test-hdr2data, echo=FALSE, results=hide>>=
...
scan.txt.Witec.Graph ("txt.Witec/nofilename (Header).txt", encoding = "latin1")
@
