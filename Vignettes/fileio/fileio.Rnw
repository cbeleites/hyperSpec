...
<<test-hdr2data, echo=FALSE>>=
read.spc ("spc/BARBITUATES.SPC", keys.hdr2data = TRUE)
@ 
...
@
<<Horiba-spc, echo=FALSE, results=hide>>=
read.spc("spc.LabRam/LabRam-1.spc")
read.spc("spc.LabRam/LabRam-2.spc")
@
