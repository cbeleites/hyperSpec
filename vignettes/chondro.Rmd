...
#   fig.path   = "resources/figures/Chondro--"
# )
```
...
knitr::include_graphics("resources/080606d-flip-ausw.jpg")
```
...
# Download file from:
raw_data_url <-
  'https://media.githubusercontent.com/media/cbeleites/hyperSpec/master/Vignettes/fileio/txt.Renishaw/chondro.txt'
...
```{r session-info-chondro, echo=FALSE, paged.print=FALSE, eval=FALSE}
