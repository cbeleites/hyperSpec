---
# For bookdown ---------------------------------------------------------------
# `flu`: Calibration of Quinine Fluorescence Emission {#flu}
# For vignette ---------------------------------------------------------------
title:       Calibration of Quinine Fluorescence Emission
subtitle:    Vignette for the Data Set `flu` of the R package **hyperSpec**
# subtitle:  Vignette on hyperSpec's flu data set
description: "flu: Example work flow for hyperSpec's fluorescence example data set `flu`."
# file_name: flu
# Authors --------------------------------------------------------------------
author:
...
#   fig.path   = "resources/figures/flu--"
# )
```
...
```{r read.txt.PE}
# FIXME: this code is not user-fiendly.
source("resources/read.txt.PerkinElmer.R")

files <- Sys.glob("resources/fileio/txt.PerkinElmer/flu?.txt")
...
```{r rawfig, fig.cap=CAPTION, fig.width=6, fig.height=3}
plot(flu)
```
...
```{r calplot1, fig.cap=CAPTION, fig.width=4, fig.height=3}
plotc(flu[, , 450])
```
...
```{r calplot2, fig.cap=CAPTION, fig.width=4, fig.height=3}
...
```{r calplot3, fig.cap=CAPTION, pdf=TRUE, eps=FALSE, fig.width=6, fig.height=3}
...
```{r calplot4, fig.cap=CAPTION, pdf=TRUE, eps=FALSE, fig.width=6, fig.height=3}
panel.predict <- 
...
```{r session-info-flu, echo=FALSE, paged.print=FALSE, eval=FALSE}
