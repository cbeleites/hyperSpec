...
This part (`source("man/read.txt.PerkinElmer.R")`) is not user-friendly and must be fixed.
...
source("man/read.txt.PerkinElmer.R")

files <- Sys.glob(paste0(system.file("doc/rawdata", package = "hyperSpec"),"/flu?.txt"))
