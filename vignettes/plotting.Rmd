---
# For bookdown ---------------------------------------------------------------
# `plotting`: **_hyperSpec_** Plotting Functions {#plotting}
# For vignette ---------------------------------------------------------------
...
#   fig.path   = "resources/figures/plotting--"
# )
```
...
**Translator's notes** `plotting-1`


1. All reproducible code must be presented in the vignette (and it ir possible to do with R Markdown). And the sentences like:

    > Note that some definitions are executed in `vignette.defs`,

    must be avoided. As new users might think "What is "vignette.defs"? I'm just begginer R user?. There are no explanations on it!"
...
knitr::include_graphics("resources/plotting--fig-3D-01.png")
```
...
```{r rgl-do, echo=TRUE, results='hide', eval=FALSE}
...
<!-- ======================================================================= -->
```{block, type="note-t", echo=TRUE}
**Translator's notes** `plotting-5`


1. `FIXME:`{.r} in my opinion, "vignettes.defs" shouldn't be mentioned at all
```
<!-- ======================================================================= -->
...
```{r session-info-hyperspec, echo=FALSE, paged.print=FALSE, eval=FALSE}
