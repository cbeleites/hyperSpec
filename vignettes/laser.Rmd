...
```{r}
file  <- system.file("doc/rawdata/laser.txt.gz", package = "hyperSpec")
...
```{r cutspc, fig.cap=CAPTION, fig.width=5, fig.height=3, include=FALSE}
laser <- laser[, , -75 ~ 0]
plot(laser, "spcprctl5")
```
...
```{r wlspc, fig.cap=CAPTION, fig.width=5, fig.height=3, include=FALSE}
plot(laser, "spcprctl5")
```
...
knitr::include_graphics("man/laser-rgl-3d.png")
```
